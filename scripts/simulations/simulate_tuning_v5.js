...
// Override with V5 Proposed Settings
GAME_CONSTANTS.PLAYER.INITIAL_XP_TO_LEVEL = 50; // Slight bump from 45
GAME_CONSTANTS.PLAYER.LEVELING.EARLY_XP_BOOST_MULTIPLIER = 1.5; // Reduced from 2.0
GAME_CONSTANTS.PLAYER.LEVELING.EARLY_XP_BOOST_DURATION = 30; // Reduced from 60s
...
// With spawn nerf (0.85x), base rate drops slightly.
const XP_RATES = [
    { name: "Slow Start (3.5 XP/s Base)", rate: 3.5 },
    { name: "Average Start (7 XP/s Base)", rate: 7 },
    { name: "Good Start (10 XP/s Base)", rate: 10 },
    { name: "High Intensity (25 XP/s Base)", rate: 25 } // Simulating the 1-minute mark flow
];

const TARGET_LEVELS = [2, 3, 5, 10, 20];

console.log("=== XP TUNING SIMULATION V5 (Refined Early Game) ===");
