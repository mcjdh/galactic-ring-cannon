/**
 * 🍓 Performance Profiler for Raspberry Pi 5 Testing
...
class PerformanceProfiler {
     ...
     */
        ...
        if (this.verbose || (target && duration > target)) {
            const status = target && duration > target ? '⚠️' : '✅';
    ...
    report() {
        ...
        console.log('📊 ═══════════════════════════════════════════════════');
        console.log('📊 PERFORMANCE REPORT (Pi5 Optimization)');
        console.log('📊 ═══════════════════════════════════════════════════');
        ...
        for (const [system, timings] of Object.entries(this.systemTimings)) {
            ...
            const status = target && avg > target ? '⚠️' : '✅';
...
if (typeof window !== 'undefined') {
    ...
    window.profileOn = () => {
        ...
        console.log('🔍 Performance profiling enabled (verbose mode)');
    };
