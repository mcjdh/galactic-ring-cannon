...
class StatsManager {
    ...
    update(deltaTime) {
        ...
        // Update Edge Walker achievement (time at low health for Cybernetic Berserker unlock)
        // Reuse 'player' variable from distance tracking above
        if (player) {
            this.achievementSystem?.updateEdgeWalker?.(deltaTime, player);
        }
